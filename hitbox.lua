...
-- ============================================
-- FIX: BẢO VỆ HITBOX BẢN THÂN + JUMP/GRAVITY + AUTO RE-APPLY
-- ============================================
...
LocalPlayer.CharacterAdded:Connect(function(character)
    ...
    StatusLabel.Text = "🔄 Respawned | Settings OK"
    StatusLabel.TextColor3 = Color3.fromRGB(0, 255, 100)
end)
...
-- Hitbox Size
SizeSlider.FocusLost:Connect(function(enter)
    if enter then
        local val = tonumber(SizeSlider.Text)
        if val and val >= 1 and val <= 30 then
            getgenv().HeadSize = val
            StatusLabel.Text = "🟢 Hitbox Size: " .. val
            Sta
